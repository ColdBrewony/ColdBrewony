<!-- ════════════════════════════════════════════════════════════ -->
<!-- ① 헤더 배너 (capsule-render waving) — coffee-900 → coffee-700 → ice-500 -->
<!-- ════════════════════════════════════════════════════════════ -->
...
## 🧊 GitHub 통계 <sub>Stats</sub>

<table>
  <tr>
    <td>
      <img
        src="https://github-readme-stats.vercel.app/api?username=ColdBrewony&show_icons=true&count_private=true&include_all_commits=true&theme=tokyonight&hide_border=true&bg_color=0F1117&icon_color=8FB3CC&title_color=C8A27C&text_color=E8D8C3"
        alt="ColdBrewony's GitHub Stats"
      />
    </td>
    <td>
      <img
        src="https://github-readme-stats.vercel.app/api/top-langs/?username=ColdBrewony&layout=compact&langs_count=8&theme=tokyonight&hide_border=true&bg_color=0F1117&title_color=C8A27C&text_color=E8D8C3"
        alt="ColdBrewony's Top Languages"
      />
    </td>
  </tr>
</table>
...
<img
  src="https://streak-stats.demolab.com?user=ColdBrewony&theme=tokyonight&hide_border=true&background=0F1117&ring=C8A27C&fire=3DBE9B&currStreakLabel=8FB3CC&sideLabels=E8D8C3&dates=8FB3CC"
  alt="ColdBrewony's Commit Streak"
/>

<img
  src="https://github-profile-trophy.vercel.app/?username=ColdBrewony&theme=tokyonight&no-frame=true&column=7&margin-w=8&margin-h=8"
  alt="ColdBrewony's Trophies"
/>

<img
  src="https://github-readme-activity-graph.vercel.app/graph?username=ColdBrewony&theme=tokyo-night&bg_color=0F1117&color=8FB3CC&line=C8A27C&point=3DBE9B&hide_border=true&area=true"
  alt="ColdBrewony's Activity Graph"
/>

<!-- ════════════════════════════════════════════════════════════ -->
<!-- ⑤ 스네이크 컨트리뷰션 그래프 (Platane/snk → output 브랜치) -->
<!-- 워크플로: .github/workflows/snake.yml 이 output 브랜치에 SVG 생성 -->
<!-- ════════════════════════════════════════════════════════════ -->

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/ColdBrewony/ColdBrewony/output/github-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/ColdBrewony/ColdBrewony/output/github-snake.svg" />
  <img alt="github contribution snake animation" src="https://raw.githubusercontent.com/ColdBrewony/ColdBrewony/output/github-snake.svg" />
</picture>

</div>

<!-- ════════════════════════════════════════════════════════════ -->
<!-- ⑥ 블로그 (티스토리 자동 피드 — blog-post-workflow) — 좌측 정렬 -->
<!-- 워크플로: .github/workflows/blog-post-workflow.yml 이 마커 사이를 갱신 -->
<!-- ════════════════════════════════════════════════════════════ -->

## 📝 최근 블로그 글 <sub>From Tistory</sub>
...
- [[Hermes]오래된 노트북에 Xubuntu를 깔아 Hermes 서버로 쓰기까지 - 1](https://woo-nny.tistory.com/entry/Hermes%EC%98%A4%EB%9E%98%EB%90%9C-%EB%85%B8%ED%8A%B8%EB%B6%81%EC%97%90-Xubuntu%EB%A5%BC-%EA%B9%94%EC%95%84-Hermes-%EC%84%9C%EB%B2%84%EB%A1%9C-%EC%93%B0%EA%B8%B0%EA%B9%8C%EC%A7%80-1)
- [Lombok&lpar;롬복&rpar; vs Record](https://woo-nny.tistory.com/entry/Lombok%EB%A1%AC%EB%B3%B5-vs-Record)
<!-- BLOG-POST-LIST:END -->

<!-- ════════════════════════════════════════════════════════════ -->
<!-- ⑦ 포트폴리오 (빈 2x2 카드표 플레이스홀더) -->
<!-- ════════════════════════════════════════════════════════════ -->
...
<img
  src="https://capsule-render.vercel.app/api?type=waving&color=0:5B7C99,100:2A1A12&height=120&section=footer&reversal=true"
  alt="footer"
  width="100%"
/>
